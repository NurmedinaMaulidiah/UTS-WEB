...
<nav>
        <div class="wrapper">
            <!-- <div>
            <h1 class="menu">FANTASTIC FOOD</h1> -->
            <!-- </div> -->
        </div>
    </nav>
    <div class="input">
    <form action="" method="get">
        <label id="form" for=""> Menu :  </label>
        <input id="form" type="text" menu="menu" autocomplete='off'><br>
        <label id="form" for="">Harga   : </label>
        <input id="form" type="text" menu="rupiah"autocomplete='off'><br>
        <label id="form" for="">ID      : </label>
        <input id="form" type="text" menu="id" required autocomplete='off'> <br>
        <label id="form" for="">Expired : </label>
        <input id="form" type="date" menu="exp" required autocomplete='off'> <br>
        <button type="submit" name="login" id="email" class="btn btn-primary deep-purple btn-block " required>Submit</button>
    </form>
    </div>
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-7 fixed-start ms-0 " id="sidenav-main">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="../pages/billing.html">
            ...
            <span class="nav-link-text ms-1">Tampilkan Produk</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="../pages/virtual-reality.html">
            ...
            <span class="nav-link-text ms-1">Edit Harga dan Produk</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link " href="halaman baru.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
